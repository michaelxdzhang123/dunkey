# AGENTS.md
reminder: my web searching engin and embedding model alread built locally, the info in ## Local setup section
...
```text
Fixed question
  -> web search engining using SearSNX build locally
  -> embedding model using local model 
  -> GitHub search
...
```yaml
question: "What new information appeared today about physical ai platform or software "
```
...
export Qwen_KEY="your_openai_key"
export Qwen_local_url="http://172.28.21.22:8000/v1
export GITHUB_TOKEN="your_github_token"
export EMBEDDING_MODEL_NAME="Qwen3-Embedding-8B-Q4_K_M"
export EMBEDDING_URL="http://172.28.21.22:11434"
